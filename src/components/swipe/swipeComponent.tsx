...
const ItemSwipe = React.forwardRef<CountdownHandle, TItem>(({
        ...
        const onTouchStart = (e: TouchEvent) => {
            ...
            if (childRef.current) {
                childRef.current?.addEventListener('touchmove', async (event) => {
