...
const FilterEstablishments = ({
        ...
        const [averageCheckValueGte, setAverageCheckValueGte] = useState<number>(currentFilterValues?.averageCheck_gte);
        const [averageCheckValueLte, setAverageCheckValueLte] = useState<number>(currentFilterValues?.averageCheck_lte);
        ...
        useLayoutEffect(() => {
            if (currentFilterValues) {
                setAverageCheckValueLte(currentFilterValues?.averageCheck_lte)
                setAverageCheckValueGte(currentFilterValues?.averageCheck_gte)
        ...
        const handleReplace = () => {
            setSearchValue("");
            setAverageCheckValueGte(0);
            setAverageCheckValueLte(100000);
            setSearchCity("");
            setType('')
                    ...
                    <Box sx={{
                        ...
                        <Box sx={{
                            ...
                            <SelectAverageCheck
                                ...
                                valueGte={averageCheckValueGte}
                                setValueGte={setAverageCheckValueGte}
                                valueLte={averageCheckValueLte}
                                setValueLte={setAverageCheckValueLte}
