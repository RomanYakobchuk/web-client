...
//         return {
//             closeHeight: -viewportHeight * bottomThreshold,
//             defaultHeight: -viewportHeight * middleThreshold,
//             fullHeight: -viewportHeight * topThreshold,
//         };
//     };
//
//     const { closeHeight, defaultHeight, fullHeight } = getBottomSheetHeights();
//
...
//              */
//             onChange: ({ value: { y } }) => {
//                 if (y >= defaultHeight - 20 && y <= defaultHeight + 20) {
...
//             immediate: false,
//             y: defaultHeight,
//             config: configOf(defaultParam, 'default'),
//         });
//     };
//
//     /**
...
//             canceled: false,
//         };
//         if (currentThreshold === 'default') {
//             toDefaultHeight({ canceled });
//             return;
//         }
...
//         } = gestureState;
//         if (last) {
//             const isBelowFullHeightThreshold = my > 60;
//             if (close) {
//                 toCloseHeight({ velocity: vy });
//             } else if (isBelowFullHeightThreshold) {
//                 toDefaultHeight({ canceled });
//             } else {
//                 resetToClosestThreshold({ canceled });
//             }
...
//         currentThreshold === 'full' ? toDefaultHeight() : toFullHeight();
//     };
//
//     /**
