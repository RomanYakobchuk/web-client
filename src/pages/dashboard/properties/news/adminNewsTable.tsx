...
import NewsFiltersStat from "@/pages/dashboard/properties/news/newsFiltersStat";
import NewsStat from "@/pages/dashboard/properties/news/newsStat";
import {
    INews,
    ...
    const columns = useMemo<GridColDef<INews>[]>(
        () => [
            ...
            },
            {
                ...
                renderCell: function render({row}) {
                    const {_id: establishmentId} = row.establishmentId as IEstablishment;
